...
const StepperCustomHorizontal = () => {
  ...
  const [dénomination, setDénomination] = useState<string>('')
  const [juridique, setJuridique] = useState<string>('')
  const [nom_commercial, setNomCommercial] = useState<string>('')
          ...
          <Fragment>
            <Grid item xs={12} sm={6}>
              ...
              <TextField
                fullWidth
                value={juridique}
                placeholder='Société en participation'
                onChange={e => setJuridique(e.target.value)}
              />
            </Grid>
              <Grid item xs={12} sm={6}>
              <p>Dénomination :</p>
              <TextField
                fullWidth
                onChange={e => setDénomination(e.target.value)}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <p>Nom commercial :</p>
