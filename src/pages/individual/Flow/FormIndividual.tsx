        ...
        return (
          ...
          <Fragment>
            ...
            <Grid item xs={12} sm={6} >
             ...
             <p>Dénomination </p>
              <TextField fullWidth 
                value={dénomination} onChange={e => setDenomination(e.target.value)}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <p>Nom de commerce </p>
            ...
            <Grid item xs={12} sm={6} >
                ...
                <FormControl fullWidth >
                  ...
                  >
                    ...
                    <MenuItem value='Culture de légumineuses et cultures industrielles'>Culture de légumineuses et cultures industrielles</MenuItem>
        ...
        case 4:
          return (
            <Fragment key={step}>
              ...
              <TextField
                fullWidth
                value={Télephone_Plus}
                onChange={e => setTélephone_Plus(e.target.value)} />
            </Grid>
              <Grid item xs={12} sm={6} >
                <p>Fax</p>
                <TextField fullWidth value={Fax} onChange={e => setFax(e.target.value)} />
              ...
              <TextField
                fullWidth
                value={Email_Plus}
                onChange={e => setEmail_Plus(e.target.value)}/>
            </Grid>
            <Grid item xs={12} sm={6}>
                <p>Situation</p>
