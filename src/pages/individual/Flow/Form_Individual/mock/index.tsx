export const getJuridique = async () => {
    const mockOptions = [
        ...
        { value: 'Société unipersonnelle à responsabilité limitée', label: 'Société unipersonnelle à responsabilité limitée' },
...
export const getActivite = async () => {
    const mockOptions = [
        ...
        { value: 'Culture de légumineuses et cultures industrielles', label: 'Culture de légumineuses et cultures industrielles' },
